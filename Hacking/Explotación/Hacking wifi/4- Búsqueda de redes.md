Para buscar las redes debemos activar previamente el [Modo monitor de la antena](Modo%20monitor%20de%20la%20antena.md) para realizar este escaneo de redes, el cual se hace de la siguiente manera.
