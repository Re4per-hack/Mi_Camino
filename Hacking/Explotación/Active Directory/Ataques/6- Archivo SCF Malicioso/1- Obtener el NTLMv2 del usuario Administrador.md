...
ppPara esto tenemos que aprovecharnos de algún recurso que esté siendo hosteado por el administrador (revisar [[smbmap]])y que tengamos acceso, posteriormente, vamos a crear un archivo csf maliciosos, lo interesante de estos archivos es que se puede indicar la ruta por la cual se va a cargar el icono, obviamente podemos poner nuestra maquina como si fuera un recurso que está compartiendo ese icono, el archivo se veria algo así:
